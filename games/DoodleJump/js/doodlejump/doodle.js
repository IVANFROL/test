...
((Doodle = Doodle || {}).BootState = {
  ...
  ((Doodle = Doodle || {}).NameInput = {
    create: function () {
      ...
      this.enterKey.onDown.add(this.saveName, this);
    },
    saveName: function () {
...
((Doodle = Doodle || {}).CalibrateState = {
  ...
  create: function () {
    ...
    var e,
      s = new FULLTILT.getDeviceOrientation({
        type: "world",
      }),
      i = this;
  ...
  ((Doodle = Doodle || {}).GameState = {
      ...
      if ("fearless" != this.name) {
        ...
        2 == t &&
          ...
          1 == t &&
            ...
            (tween2 = this.game.add.tween(this.player.scale).to(
              {
                x: 0,
                y: 0,
              },
    ...
    achieveMentUnlock: function (t, e) {
      1 != this.stats.achievements[t][3] &&
        ...
        (tween1 = this.game.add.tween(this.achievementsGroup).to(
          {
            y: -84,
          },
          1e3,
        ...
        (tween12 = this.game.add.tween(this.achievementsGroup).to(
          {
            y: 0,
          },
          1e3,
  ...
  ((Doodle = Doodle || {}).MenuState = {
    ...
    create: function () {
      ...
      (this.platform = this.add.sprite(60, 900, "atlas", "platform0")),
        ...
        (this.playButton = this.add.sprite(130, 330, "atlas", "Play_01")),
